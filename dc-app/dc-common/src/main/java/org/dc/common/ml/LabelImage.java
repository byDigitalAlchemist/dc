...
public class LabelImage {
	...
	public static void main(String[] args) {
		...
		String[] argsd = new String[2];
		
		argsd[0] = "D://CHEMIST//TENSORFLOW//inception5h";
		argsd[1] = "D://CHEMIST//TENSORFLOW//library.jpg";

		if (argsd.length != 2) {
			printUsage(System.err);
			System.exit(1);
		}
		String modelDir = argsd[0];
		String imageFile = argsd[1];
